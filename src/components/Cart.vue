    ...
    <v-card>
                ...
                >
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle>
                            Rp. {{ item.price.toLocalString('id-ID')}}
                            ({{ item.weight }} kg)
        ...
        <v-card>
            <v-card-text>
                <v-layout wrap>
                    <v-flex pa-1 xs6>
                        Total Price ({{ totalQuantyty }} items) <br>
                        <span class="title">Rp. {{ totalPrice.toLocalString('id-ID') }}</span>
                    </v-flex>
                    <v-flex pa-1 xs6 text-right>
                        <v-btn color="primary" @click="checkout" :disabled="totalQuantyty==0">
